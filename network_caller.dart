...
import 'package:assingments/main.dart';
...
class NetworkCaller{
 ...
 static Future<NetworkResponse> postRequest({required String url,
  ...
  static void _moveToLogin()async {
   ...
   Navigator.pushAndRemoveUntil(MyApp.navigatorKey.currentContext!,
       MaterialPageRoute(builder: (context) => SingInScreen()), (p) => false);
  }
